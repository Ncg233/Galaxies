...
public static class AllTiles
{
    ...
    public static readonly Tile Torch = Register("torch", new TorchTile(new TileSettings().SetFullTile(false)));
    ...
    public static readonly Tile Chest = Register("chest", new ChestTile(new TileSettings().SetFullTile(false).SetCanCollide(false)));
